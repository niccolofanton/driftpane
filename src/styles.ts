...
.dp-share-card-icon {
	...
	flex: none;
	opacity: 0.85;
	background-color: var(--tp-label-foreground-color, #d6d7db);
...
.dp-share-card-name {
	...
	font-weight: 700;
	line-height: 1.3;
	color: var(--tp-button-foreground-color, #e3e3e8);
...
.dp-share-btn-primary {
	background: var(--tp-button-background-color-active, hsla(240, 7%, 38%, 1));
}
.dp-share-btn-primary:hover {
	filter: brightness(1.08);
}
.dp-share-btn-ghost {
	background: var(--tp-button-background-color, hsla(240, 5%, 22%, 0.9));
}
.dp-share-btn-ghost:hover {
	background: var(--tp-button-background-color-hover, hsla(240, 5%, 28%, 0.95));
}
